...
resources = [
    ...
    Resource(title="iMasons Innovation Podcast", description="A podcast series tackling technology's toughest challenges with a focus on shaping a sustainable digital future. Each episode features global innovators sharing insights and ideas to drive the growth of digital infrastructure. Hosted by iMasons Innovation Committee Chair Romain Tranchant, it's available on YouTube, Spotify, Apple Podcasts, and more.", url="https://youtube.com/playlist?list=PLrZMAz7fZps09Vy9XfEzJNIg8mIudPjKk&si=Ehss3X_7OZ_3GI0i"),
    Resource(title="iMasons Job Matching Platform", description="A purpose-built tool that connects top-tier talent with leading digital infrastructure companies, using advanced skills-matching technology to align candidates' experience and education with job postings from partner companies. For job seekers, it offers a clear, customized view of opportunities aligned with their skills and interests across various locations, making the job search more strategic and effective.", url="https://imasons.org/initiatives/people/job-matching-platform/"),
    Resource(title="iMasons Membership", description="iMasons is a global, non-profit, professional association of individuals connected and empowered to build a greater digital future for all. Individual membership ($99/year) grants access to a worldwide network of digital infrastructure professionals, committees, events, resources, and career development opportunities. Student memberships are complimentary for those with a .edu email address.\nUse code imemerging for $1 membership in first year and join our Emerging Talent group.", url="https://imasons.org/membership-application/?member-type=Individual%20Member%20-%20$99/year"),
    Resource(title="iMasons Industry Events",description="iMasons hosts events that develop opportunities for specific communities and support members in advancing their careers — from masterclasses to meetups with role models. These span global conferences, local chapter gatherings, and virtual sessions, bringing together professionals across the digital infrastructure ecosystem.",url="https://imasons.org/events/"),
    Resource(title="Get Involved (iMasons Foundation)",description="iMasons Foundation expands access and prepares the next generation of digital infrastructure talent. The foundation engages students and professionals to create greater awareness of career opportunities in the growing digital infrastructure industry, promoting training and transition programs and showcasing career pathways into the field.",url="https://imasons.org/initiatives/people/imasons-foundation/imasons-foundation-interest-students-professional/")
]
